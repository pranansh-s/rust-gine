...
use crate::entity::dynamic_renderer::DynamicRenderer;
...
impl Character {
    pub fn new(name: &'static str, shader_path: &str, texture_path: &str, ortho: glm::Mat4, transform: Transform) -> Self {
        ...
        unsafe {
            ...
            renderer = DynamicRenderer::new(program.clone());
        }
